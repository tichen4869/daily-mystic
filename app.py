...
# 事项对应的五行属性（用于个性化宜忌）
THING_WUXING = {
    "面试谈判": "金", "入职上任": "土", "开业创业": "金",
    "签合同": "金", "谈生意": "金", "收款理财": "金",
    "商务合作": "金", "考试学习": "木", "升学考公": "木",
    "社交聚会": "火", "拓展人脉": "火", "出差旅行": "木",
    "休息放松": "水", "断舍离": "金", "大扫除": "水",
    "购物买衣": "金", "护肤美容": "水", "换发型": "金",
    "做美甲": "金", "请客吃饭": "火", "看医生体检": "水",
    "表白约会": "火", "相亲见面": "火", "备孕": "水",
    "换家具": "土", "搬新家": "土", "搬家": "土",
    "装修改造": "土", "开工建设": "土", "买房投资": "土",
    "养花种草": "木", "养宠物": "木",
    "感恩回顾": "火", "还愿许诺": "火",
    "做公益": "火", "帮助他人": "火",
    "开运转运": "火", "搞创作": "木", "打扮出席": "金",
    "运动冒险": "木", "修缮维护": "土", "整理环境": "土",
    "策划筹备": "水", "清理杂务": "金", "项目封顶": "土",
    "搭建框架": "木", "换厨房电器": "火", "手工创作": "木",
    "布置家居": "土", "调整布局": "火", "处理积压": "水",
    "抓住机会": "金", "启动新项目": "木",
    "冥想静心": "水", "放松垂钓": "水", "告别过去": "水",
}
...
YI_JI_TRANSLATE = {
    # 事业工作
    "祈福": "面试谈判", "上官赴任": "入职上任", "开市": "开业创业",
    "立券": "签合同", "交易": "谈生意", "纳财": "收款理财",
    "订盟": "商务合作", "习艺": "考试学习", "入学": "升学考公",
    "会亲友": "社交聚会", "结网": "拓展人脉", "出行": "出差旅行",
    # 生活日常
    "沐浴": "休息放松", "解除": "断舍离", "扫舍": "大扫除",
    "裁衣": "购物买衣", "整容": "护肤美容", "剃头": "换发型",
    "整手足甲": "做美甲", "宴会": "请客吃饭",
    "求医疗病": "看医生体检",
    # 家庭
    "嫁娶": "表白约会", "纳采": "相亲见面", "求嗣": "备孕",
    "安床": "换家具", "入宅": "搬新家", "移徙": "搬家",
    "修造": "装修改造", "动土": "开工建设", "置产": "买房投资",
    "栽种": "养花种草", "纳畜": "养宠物",
    # 精神层面
    "祭祀": "感恩回顾", "酬神": "还愿许诺",
    "恤孤茕": "做公益", "覃恩": "帮助他人",
